...
const menuContent = function() {
  ...
  const para =  buildElement("p", "info4", "this is a test. menu menu menu here is a long sentence or paragraph that I don't know how to add or how to remove.", "paraMenuID")
